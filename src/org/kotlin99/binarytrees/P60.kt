...
fun maxNodeAmountInHBTree(height: Int): Int = TODO()

fun minNodeAmountInHBTree(height: Int): Int = TODO()

fun maxHeightOfHBTree(nodeAmount: Int): Int = TODO()

fun minHeightOfHBTree(nodeAmount: Int): Int =
        if (nodeAmount == 0) 0
        else minHeightOfHBTree(nodeAmount / 2) + 1

fun <T> Tree.nodeCount(): Int = TODO()

fun <T> allHBTreesWithNodeAmount(nodeAmount: Int, value: T): List<Tree> {
    TODO()
}
